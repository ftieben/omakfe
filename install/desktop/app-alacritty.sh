...
cp ~/.local/share/omakfe/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/omakfe/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/omakfe/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
...
source ~/.local/share/omakfe/install/desktop/set-alacritty-default.sh
