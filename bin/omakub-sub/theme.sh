...
if [ -n "$THEME" ] && [ "$THEME" != "<<-back" ]; then
  cp $OMAKFE_PATH/themes/$THEME/alacritty.toml ~/.config/alacritty/theme.toml
  cp $OMAKFE_PATH/themes/$THEME/zellij.kdl ~/.config/zellij/themes/$THEME.kdl
  sed -i "s/theme \".*\"/theme \"$THEME\"/g" ~/.config/zellij/config.kdl
  if [ -d "$HOME/.config/nvim" ]; then
    cp $OMAKFE_PATH/themes/$THEME/neovim.lua ~/.config/nvim/lua/plugins/theme.lua
  fi

  if [ -f "$OMAKFE_PATH/themes/$THEME/btop.theme" ]; then
    cp $OMAKFE_PATH/themes/$THEME/btop.theme ~/.config/btop/themes/$THEME.theme
  ...
  source $OMAKFE_PATH/themes/$THEME/gnome.sh
  source $OMAKFE_PATH/themes/$THEME/tophat.sh
  source $OMAKFE_PATH/themes/$THEME/vscode.sh
  ...
  # source $OMAKFE_PATH/themes/$THEME/chrome.sh
fi
